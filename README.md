...
Функция connect принимает две функции  mapStateToProps, mapDispatchToProps и передает презентационной компонене все данные и ВОЗВРАЩАЕТ контейнерную компоненту.
